      ...
      <div class="w-full px-2 gap-2 flex flex-col">
        <div :class="collapsed ? 'px-1' : ''">
          ...
          <DropdownComponent independent>
            <template #activator>
              <img :src="authStore.currentUser.picture" class="w-8 ml-2 mt-1 rounded-full" />
            </template>

            <DropdownItemComponent >
              <div class="flex items-center gap-2 whitespace-nowrap md:w-40">
                <IconBase>
                  <SettingIcon />
                </IconBase>
                <NuxtLink to="/profile">
